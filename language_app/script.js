...
const voiceMemos = [
    ...
    { name: 'voice-memo-3.wav', transcript: "Hey there! My girlfriends and I are planning a getaway to Greece—finally! We’re thinking Santorini, but we’re open to other islands too. We want beaches, wine, and maybe a little adventure. What’s the best time to go for good weather but fewer crowds? And can you help us find a cute villa?" }
];
